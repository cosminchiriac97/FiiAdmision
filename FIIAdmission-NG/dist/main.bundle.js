...
var Authentication = (function () {
    ...
    Authentication.prototype.login = function (userName, password) {
        ...
        res.subscribe(function (data) { return localStorage.setItem('currentUser', JSON.stringify(data)); }, function (error) { return alert('error'); });
        return res;
    };
...
module.exports = "<dashboard-sidenav>\n  <div class=\"dash-container\">\n    <div id=\"news\">\n      <div class=\"col-md-8 col-md-offset-2\" id=\"welcome-panel\">\n        <h2 class=\"col-md-4 col-md-offset-5\" style=\"margin-bottom:20px;\">News!</h2>\n        <app-news class=\"col-md-4 col-md-offset-1\"></app-news>\n      </div>\n    </div>\n  </div>\n  <div class=\"dash-container\">\n    <div id=\"notifications\">\n      <div class=\"col-md-8 col-md-offset-2\" id=\"welcome-panel\">\n        <h2 class=\"col-md-4 col-md-offset-5\" style=\"margin-bottom:20px;\">Notifications</h2>\n        <app-notifications class=\"col-md-10 col-md-offset-1\">\n        </app-notifications>\n      </div>\n    </div>\n  </div>\n  <div class=\"dash-container\" id=\"form\">\n    <div class=\"col-md-8 col-md-offset-2\" id=\"welcome-panel\">\n      <h2 class=\"col-md-4 col-md-offset-5\" style=\"margin-bottom:20px;\">Application Form</h2>\n      <app-fii-form class=\"col-md-8 col-md-offset-2\" [fields]=\"fields\">\n      </app-fii-form>\n    </div>\n  </div>\n</dashboard-sidenav>"
        ...
        this.fields = [
            ...
            },
            {
                ...
                checkChoices: ['Came from foster homes', 'Came from foster care', 'Came from single-parent households',
                    'Orphan of one parent', 'Orphan of both parents', 'Candidate falls within '],
                selectOptions: [],
                value: ''
            }
        ];
